...
# - tweets tokenizer
# - embeddings
# - no trainable embeddings (only work when embedding path is provided)
...
MODEL_NAME="twconvrsu_v1d2i_10k" # change to your model name

PROJECT_ID=$(gcloud config list project --format "value(core.project)")
#BUCKET=${PROJECT_ID}-chatbot
BUCKET=${PROJECT_ID}-chatbot
DATA_DIR=gs://${BUCKET}/twconvrsu_tf_v2i_10k
