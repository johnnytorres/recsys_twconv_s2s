...
# invoke deployed model to make prediction given new datasets instances
gcloud ml-engine predict --model=${MODEL_NAME} --version=${MODEL_VERSION} --json-instances=datasets/new-datasets.json