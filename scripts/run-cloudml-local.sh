...
DATA_DIR=datasets/convusersec/twconvrsu_tf_v1
...
# invoke trained model to make prediction given new datasets instances
#gcloud ml-engine local predict --model-dir=${MODEL_LOCATION} --example-instances=datasets/new-datasets.json