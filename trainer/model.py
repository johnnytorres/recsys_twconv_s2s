...
from trainer import featurizer
	...
	def build_embedding_layer():
		...
		if task.HYPER_PARAMS.embedding_path:
			...
			if embedding_vectors is None:
				embedding_vectors, embbeding_dict = embeddings_builder.load_embedding_vectors(task.HYPER_PARAMS.embedding_path, set(vocab_array))
			initializer = build_initial_embedding_matrix(vocab_dict, embbeding_dict, embedding_vectors, task.HYPER_PARAMS.embedding_size)
